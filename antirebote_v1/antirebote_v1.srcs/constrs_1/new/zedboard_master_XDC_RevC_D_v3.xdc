...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {debounce_output}];  # "LD0"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {debounce_input}];  # "BTNC"
#set_property PACKAGE_PIN R16 [get_ports {acuse_error_comp}];  # "BTND"
...
#set_property PACKAGE_PIN G22 [get_ports {frec_selec[1]}];  # "SW1"
