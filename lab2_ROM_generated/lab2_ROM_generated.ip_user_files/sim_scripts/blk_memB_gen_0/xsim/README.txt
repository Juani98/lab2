...
#
# Generated by export_simulation on Tue Jun 07 12:20:34 -0300 2022
#
################################################################################
...
'-reset_run' switch to the './blk_memB_gen_0.sh' script.

./blk_memB_gen_0.sh -reset_run
...
./blk_memB_gen_0.sh -noclean_files

For more information on the script, please type './blk_memB_gen_0.sh -help'.
