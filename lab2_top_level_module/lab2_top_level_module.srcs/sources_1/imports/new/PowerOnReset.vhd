...
------------------------------------------------------------------
 -- Enitiy --
------------------------------------------------------------------
entity rst_async_ass_synch_deass_v2 is
    generic(
        rst_width:integer:=2; 
        rst_active_value: std_logic:='1'--reset activo en alto
    );
    port(
...
end entity rst_async_ass_synch_deass_v2;
------------------------------------------------------------------
 -- Architecture --
------------------------------------------------------------------
architecture rst_async_ass_synch_deass_beh of rst_async_ass_synch_deass_v2 is
