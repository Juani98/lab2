...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clka, wea, addra, dina, douta, clkb, web, addrb, dinb, 
  doutb)
/* synthesis syn_black_box black_box_pad_pin="clka,wea[0:0],addra[2:0],dina[8:0],douta[8:0],clkb,web[0:0],addrb[2:0],dinb[8:0],doutb[8:0]" */;
  input clka;
  input [0:0]wea;
  input [2:0]addra;
  input [8:0]dina;
