...
#
# Generated by export_simulation on Thu Jun 16 00:09:57 -0300 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_0_ROM_B.sh' script.

./blk_mem_gen_0_ROM_B.sh -reset_run
...
./blk_mem_gen_0_ROM_B.sh -noclean_files

For more information on the script, please type './blk_mem_gen_0_ROM_B.sh -help'.
